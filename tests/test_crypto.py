...
# Version: 1.9.3
# Changelog:
# - 1.9.3: Dynamische Telepraxis-Versionskennung auf 1.9.3 aktualisiert.
# - 1.9.2: Dynamische Telepraxis-Versionskennung auf 1.9.2 aktualisiert.
# - 1.9.1: Dynamische Telepraxis-Versionskennung auf 1.9.1 aktualisiert.
...
def test_encrypted_file_decrypts_to_transport_record(app_config, private_key) -> None:
    ...
    assert record["user_agent"] == "kienzlefon/1.9.3"
