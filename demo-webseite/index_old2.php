...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .hero {
      background:
        radial-gradient(circle at 8% 12%, rgba(196, 13, 30, .08), transparent 34%),
    ...
    .form-body { padding: 8px 28px 28px; }
  ...
  <main id="top">
      ...
      <div class="hero-inner">
        <div class="hero-copy">
          ...
          <div class="hero-actions">
            ...
            <a class="button button-secondary" href="./inbox/">Demo-Nachrichten ansehen</a>
          </div>
    ...
    <section class="telepraxis-section" aria-labelledby="telepraxis-title">
      <div class="telepraxis-heading">
        <h2 id="telepraxis-title">Telepraxis-Demo</h2>
